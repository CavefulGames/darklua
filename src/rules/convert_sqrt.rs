...
pub const CONVERT_SQRT_RULE_NAME: &str = "convert_sqrt";

/// A rule that converts math.sqrt into exponentiation.
#[derive(Debug, Default, PartialEq, Eq)]
pub struct ConvertSqrt {}

impl FlawlessRule for ConvertSqrt {
...
impl RuleConfiguration for ConvertSqrt {
...
mod test {
    ...
    fn serialize_default_rule() {
        ...
        assert_json_snapshot!("default_convert_sqrt", rule);
    }
